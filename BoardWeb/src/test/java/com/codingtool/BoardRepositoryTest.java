...
import com.codingtool.board.domain.Role;
import com.codingtool.board.persistence.BoardRepository;
import com.codingtool.board.persistence.MemberRepository;
...
public class BoardRepositoryTest {
	...
	public void testInsert() {
		...
		for(int i=1; i<=13; i++) {
			...
			board.setTitle(member1.getName() + "의 게시글_" + i);
			board.setContent(member1.getName() + "의 게시글 내용_" + i);
		...
		for(int i=1; i<=3; i++) {
			...
			board.setTitle(member2.getName() + "의 등록한 게시글_" + i);
			board.setContent(member2.getName() + "의 등록한 게시글 내용_" + i);
			boardRepo.save(board);
		}
